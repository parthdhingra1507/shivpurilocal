...
// Category Management
let currentCategory = null; // null means showing category selection
const categorySelection = document.getElementById('category-selection');
const busScheduleContainer = document.querySelector('.bus-schedule-container');
...
// Category card and nav link listeners
document.querySelectorAll('.category-card, .main-nav a').forEach(el => {
